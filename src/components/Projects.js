    ...
    <>
      ...
      <section className="projects">
          ...
          <div className="star-project">
            <a href="https://customreactapp.herokuapp.com/" target="_blank">
          ...
          <div className="other-project-group">
            <div className="other-project iron-sharer">
              <a href="https://ironhack-sharer.herokuapp.com/" target="_blank">
                <div className="project-overlay">
                  <h2>IRON SHARER</h2>
                </div> 
              </a>
            ...
            <div className="other-project back-to-school">
              <a href="https://emmanuellejaldorau.github.io/game-project/" target="_blank">
                <div className="project-overlay">
